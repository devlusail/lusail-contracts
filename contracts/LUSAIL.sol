...
contract LUSAIL is IBEP20, Ownable {
    using SafeMath for uint256;

    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private constant ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "LUSAIL";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 amountReceived = excludeTax[sender] ?  amount:takeTax(sender, recipient, amount);
    ...
    function setExcludeTax(address addr, bool isExcluded) external onlyOwner {
    ...
    function setTaxReceivers(address _tax1, address _tax2, address _tax3) external onlyOwner {
    ...
    function setTaxThreshold(uint256 _amount) external onlyOwner {
